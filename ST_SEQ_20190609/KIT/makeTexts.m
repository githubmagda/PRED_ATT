...
switch textName
    ...
    case 'localizer'
        ...
        exper.texts.localizer= [exper.texts.localizer, 'Otherwise, you''ll have to start over', '\n'];
    ...
    case 'staircase'
        ...
        exper.texts.staircase = [exper.texts.staircase, 'The red pointer shows the corner', '\n'];
    ...
    case 'localizer'
        ...
        exper.texts.localizer = [exper.texts.localizer,'But ALWAYS keep your gaze on the fixation cross in the center','\n\n\n'];            
        exper.texts.localizer = [exper.texts.localizer,'If your gaze leaves center, the cross will turn red','\n'];            
    ...
    case 'nextSeries'    
        ...
        exper.texts.nextSeries = [exper.texts.nextSeries,'But remember to keep your gaze at center','\n'];        
    ...
    case 'recalibrate'
        ...
        exper.texts.reCalibrate = [exper.texts.reCalibrate, 'Keep looking at that dot up until the next one appears', '\n'];
