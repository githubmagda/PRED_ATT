...
% stuff:
% N.B. changed variable 'p' to 'probe' to avoid confusion with parameter
% structure 'p'
...
% stair input
probeset    = .1 : .01 : 4 ; % -15:0.5:15;        % set of possible probe values
meanset     = .1 : .01 : 4 ; % -10:0.2:10;      % sampling of pses, doesn't have to be the same as probe set
...
for ktrial = 1:ntrial
    % trial
    [thisProbe,entexp,ind]  = stair.get_next_probe();      % get next probe to test
