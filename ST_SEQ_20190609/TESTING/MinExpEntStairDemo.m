...
% stair input
probeset    = .1:.1:4; % -15:0.5:15;        % set of possible probe values
meanset     = .1:.1:4; % -10:0.2:10;      % sampling of pses, doesn't have to be the same as probe set
...
truedl  = 2; %4;        % (75%-25% point)/2 if guess rate is 0. In general, take the position of the halfway points between the inflection point and the upper and lower asymptotes, then its the distance between them
