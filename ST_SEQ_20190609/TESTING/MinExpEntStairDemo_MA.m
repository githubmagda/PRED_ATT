...
% stair input
probeset    = .1:.1:2; % -15:0.5:15;        % set of possible probe values
meanset     = .2:.1:1.9; % -10:0.2:10;      % sampling of pses, doesn't have to be the same as probe set
