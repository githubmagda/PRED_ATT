...
%set debug window dimension
testWindowDimensions = [0,0, 500, 500];
...
[window, windowRect] = PsychImaging('OpenWindow', screenNumber, grey, testWindowDimensions);
